...
final class CodeMatcher
{
    ...
    private const PATTERNS = [
        '[A-Z0-9]{3,4}\/[A-Z0-9]{3}\/\d{5}\/\d{2}',   // АльфаСтрахование: 8991/046/00754/25, 806/046/06946/25, S492/PVU/02192/25
        ...
        'SGZA ?\d{10}\/?[A-Z]{0,2}№\d{7}(?:[A-ZА-Я]\d{0,2})?',               // СОГАЗ: SGZA0000760489D№0000002, SGZA 0001685999/RD№0000001Д1, SGZA0002400786D№0000001F18
        '\d{2,4}(?:-\d{2})? M[TS] \d{4,5} ?[A-Z]{0,5}(?:\/[A-Z]{3,5})?(?:\/\d{2}D)?№\d{7}(?:[A-ZА-Я]\d{0,2})?', // СОГАЗ: 24-82 MT 2467VTBD/AOND№0000001, 1824-41 MT 1001/AONAB/04D№0000056, 1023 MT 0787KL/AOND№0000001, 25 MT 2842 ABD№0000001, 24 MS 0250D№0000005
    ...
    {
        // « / » и « - » с пробелами по обе стороны — разделители темы («vin … / Haval F7 / 24-82 MT …», «…/25 - LEXUS»), не часть номера:
        // иначе после нормализации он прилипает к номеру и тот не читается.
        $normalized = Code::normalize($text === null ? null : preg_replace('/\s+[\/\-–—]\s+/u', ' | ', $text));
