...
<turbo-frame id="pick-frame">
    <form method="get" action="/account/showings/pick" class="mb-4" data-turbo-frame="pick-frame" data-turbo-action="replace" data-controller="autosubmit">
    ...
    @else
        <form method="post" action="/account/showings" data-controller="select" data-turbo-frame="_top">
            @csrf
