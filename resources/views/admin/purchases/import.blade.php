<x-ui.shell :title="'Файл для закупки № '.$purchase->number" :trail="[['Главная', '/'], ['Закупки', '/admin/zakupki'], ['Закупка '.$purchase->number, '/admin/zakupki/'.$purchase->number], ['Файл']]" narrow>
    <x-ui.card>
    ...
    <form method="post" action="/admin/zakupki/{{ $purchase->number }}/import" class="action-bar">
