...
- «Рекомендуем» — `offers.recommended`, чекбокс в редакторе; у названия синий кружок с галочкой
  ...
  пилюля `view=recommended` (`CatalogQuery::VIEWS`, покупателю пилюли «Все / Рекомендуем» и в
  короткой ленте) и пресет `recommended` в CRM; пилюля есть, пока отмеченные есть. Одно слово везде.
