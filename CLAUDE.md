...
телефон шторка), поиск, сортировка «Наша цена». Менеджер выбран — машины
его глазами (без скрытых для него типов, `Restriction`), его чип первый,
группа «Предложения менеджеров» становится «Иванов: С его ценой / Без его
цены»; числа перекрёстные, одним проходом по лёгкой выборке;
