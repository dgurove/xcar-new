...
- **Вендоры** (`app/Vendors`, с 19.09.2026) — страховые, лизинг, банки одним
  справочником вместо `insurers` + `park_clients`: реквизиты, договор, условия
...
- **Деньги** (`app/Billing`, с 21.09.2026). Контрагент — `billing_parties`
  ...
  `buyer_storage_after_days` → покупатель по базовому прайсу). В счёт хранение
