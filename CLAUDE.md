...
- Чаты — мессенджер по образцу Авито: чат — пара (оффер, участник) + вторая сторона:
  ...
  `x-chat.row` (фото ТС с аватаром собеседника в углу, последнее, бейдж; «Администрация XCar» — `Chat::PLATFORM` — в списке всегда: обращение ещё не заведено — строка ведёт на `/account/chats/support`, первое сообщение уходит на `POST /chats/support`), чат — `x-chat.screen`
